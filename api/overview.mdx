---
title: 'API Overview'
description: "Learn about Gradiant's API architecture and capabilities"
---

## API Overview

The Gradiant API is built on modern REST principles, providing secure and efficient access to our healthcare platform's features.
