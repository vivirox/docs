...
description: "Understanding Gradiant's authentication and authorization system"
---

## Overview

Gradiant uses Supabase Auth for secure user authentication and authorization.
...
import { CardGroup, Card } from '../../components/docs/Cards'
